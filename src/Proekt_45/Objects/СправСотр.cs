...
namespace IIS.Proekt_45
{
    ...
    public class СправСотр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proekt_45.СправДолж fСправДолж;
        ...
        [PropertyStorage(new string[] {
                "СправДолж"})]
        [NotNull()]
        public virtual IIS.Proekt_45.СправДолж СправДолж
        {
            get
            {
                ...
                IIS.Proekt_45.СправДолж result = this.fСправДолж;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СправСотрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправСотрE", typeof(IIS.Proekt_45.СправСотр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СправСотрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправСотрL", typeof(IIS.Proekt_45.СправСотр));
                }
            }
        }
    }
