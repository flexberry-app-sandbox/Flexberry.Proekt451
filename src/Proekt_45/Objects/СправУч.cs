...
namespace IIS.Proekt_45
{
    ...
    public class СправУч : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proekt_45.Номер fНомер;
        
        private IIS.Proekt_45.КлассУч fКлассУч;
        ...
        [PropertyStorage(new string[] {
                "КлассУч"})]
        [NotNull()]
        public virtual IIS.Proekt_45.КлассУч КлассУч
        {
            get
            {
                ...
                IIS.Proekt_45.КлассУч result = this.fКлассУч;
        ...
        [PropertyStorage(new string[] {
                "Номер"})]
        [NotNull()]
        public virtual IIS.Proekt_45.Номер Номер
        {
            get
            {
                ...
                IIS.Proekt_45.Номер result = this.fНомер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СправУчE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправУчE", typeof(IIS.Proekt_45.СправУч));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СправУчL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправУчL", typeof(IIS.Proekt_45.СправУч));
                }
            }
        }
    }
